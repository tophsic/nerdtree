...
call s:initVariable("g:NERDTreeMapOpenInTab", "v")
call s:initVariable("g:NERDTreeMapOpenInTabSilent", "V")
...
call s:initVariable("g:NERDTreeMapRefresh", "c")
call s:initVariable("g:NERDTreeMapRefreshRoot", "C")
